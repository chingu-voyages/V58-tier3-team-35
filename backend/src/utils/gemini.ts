...
A: Core features include: interactive map display of developers, demographic filtering and search, developer profile viewing, role-based access control (Admin, Team, Guest), and AI-powered chat assistance via Versie.
...
A: Yes! Versie is your AI assistant. Versie helps you navigate the app, understand features, and answer questions about how to use ChinguVerse.

## Technical Questions

**Q5: What is Versie?**
A: Versie is the AI chatbot assistant powered by Google Gemini 2.5 Flash. I guide you around the app and help locate developers and features.
...
**Q16: Versie won't answer my question. Why?**
A: Versie follows strict privacy and security guidelines. I cannot provide precise locations, PII, or help bypass security restrictions. If your question is legitimate, try rephrasing it or contact an administrator.
...
**Q21: Does Versie provide technical support?**
A: Versie provides guidance on app usage and feature navigation only. For browser issues, internet problems, or technical troubleshooting, contact your development team.

---

**Important Privacy Reminders:**
- Versie cannot disclose precise locations of individuals
- Versie will never share IP addresses, emails, phone numbers, or PII
