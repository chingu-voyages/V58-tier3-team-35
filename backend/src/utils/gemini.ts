...
Frequently Asked Questions (FAQ) - Chingu Voyage Project: Chingu Demographics App

## General Project Questions

**Q1: What is the main objective of the Chingu Demographics App?**
A: The primary objective is to design and build a web application that aims to  provide users with insights about Chingus
